...
class Signup extends React.Component {
    ...
    async signup() {
        try {
            ...
            var res = await axios.post('https://api.fettlepool.in/api/admin/signup', {
    ...
    submitForm(e) {
        e.preventDefault();
        if (this.state.email == "" || this.state.name == "" || this.state.password == "" || this.state.mobile == "" || this.state.confirmPassword == "")
        {   this.setState({
                    loading: false,
                    snackbar: true,
                                ...
                                <div className="grid-body">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-8 col-sm-9 col-12 mx-auto form-wrapper">
                                            <form action="#">
                                                ...
                                                </div>
                                                {
                                                    this.state.loading == true ?
                                                        ...
                                                        : <button type="submit" onClick={(e) => this.submitForm(e)} className="btn  btn-block" style={{ backgroundImage: 'linear-gradient(315deg, #00bfb2 0%, #028090 74%)', color: 'white', borderRadius: 100, fontSize: 16 }}> Register as Admin </button>
                                                }
                                            </form>
                                            ...
                                            {/* <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', paddingTop: 10, paddingRight: 10 }}><p style={{ color: '#028090', fontWeight: 'bold' }}>Forgot Password |</p><p style={{ color: '#028090', fontWeight: 'bold' }}>&nbsp;Log In </p></div> */}
                                        </div>
                                    </div>
                                </div>
                            </div>
