...
export class AdminLog extends Component {
    ...
    async componentDidMount() {
        ...
        await axios({
            method: 'post',
            url: 'https://api.fettlepool.in/api/adminToken/adminLogs',
            headers: {
                'Authorization': token
            },
            data: {
                        ...
                        <div>
                            <div className="row" style={{ justifyContent: 'space-between' }}>
                                <h1 style={{ fontSize: '36px', paddingLeft: '10px', color: 'white', fontFamily: 'poppins', fontWeight: 'bolder' }}>
                                    <i class="mdi mdi-chart-donut" style={{ fontSize: '36px', paddingRight: '6px', color: 'white' }}></i>Admin Entry Log</h1>
                            </div>
                        </div>
