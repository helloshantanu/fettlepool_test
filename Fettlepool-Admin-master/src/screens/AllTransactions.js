...
export class AllTransactions extends Component {
    ...
    async componentDidMount() {
        ...
        await axios({
            method: 'post',
            url: 'https://api.fettlepool.in/api/adminToken/allTransactions',
            headers: {
                'Authorization': token
            },
            data: {
                                            ...
                                            <table class="table table-hover table-sm">
                                                <thead>
                                                    <tr class="solid-header">
                                                        <th style={{ background: 'white' }}>Customer Id</th>
                                                ...
                                                {this.state.data.map((detail, index) => (
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <small class="text-black font-weight-medium d-block">{detail.cardNo}</small>
                                                            </td>
                                                            <td>
